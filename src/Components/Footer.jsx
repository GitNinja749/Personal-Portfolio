      ...
      <footer className="footer footer-center md:p-10  text-base-content rounded dark:text-white p-4 dark:bg-gray-900">
        <nav >
          <div className="grid grid-flow-col gap-4">
              <a href="https://github.com/GitNinja749" ><FaGithub className='w-9 h-9 hover:text-black'/></a>
              ...
              <a href="https://www.instagram.com/" ><FaWhatsapp className='w-9 h-9 hover:text-green-500'/></a>
          </div>
        </nav> 
        <aside>
